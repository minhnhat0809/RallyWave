...
{
    Task<List<CourtOwner>> GetCourtOwners(string? filterField, string? filterValue);

    Task<CourtOwner?> GetCourtOwnerById(int id);
...
public class CourtOwnerRepository(RallyWaveContext repositoryContext) : RepositoryBase<CourtOwner>(repositoryContext), ICourtOwnerRepository
{
    ...
    public async Task<List<CourtOwner>> GetCourtOwners(string? filterField, string? filterValue)
    {
    ...
    public async Task<CourtOwner?> GetCourtOwnerById(int id)
    {
